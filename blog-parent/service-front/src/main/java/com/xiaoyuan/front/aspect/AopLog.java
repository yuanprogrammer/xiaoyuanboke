...
public class AopLog {
    ...
    /**
     * 切入点logback-spring.xml
     */
    @Pointcut("execution(public * com.xiaoyuan.front.controller.*Controller.*(..))")
    public void log() {
    ...
    public Object aroundLog(ProceedingJoinPoint point) throws Throwable {
        ...
        if (l.getTimeCost() > 1000) {
            FrontLog frontLog = new FrontLog();
            BeanUtils.copyProperties(l, frontLog);
            threadService.recordBlogLog(frontLog);
        }
